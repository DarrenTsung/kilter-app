          ...
          return (
            ...
            >
              ...
              <div className="relative w-3 shrink-0" style={{ minHeight: "28px" }}>
                {isSent && (
                  <svg className="absolute left-0 top-[5px]" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#737373" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                )}
                {hasBeta && (
                  <svg className="absolute left-[1px] top-[25.35px]" width="10" height="10" viewBox="0 0 24 24" fill="#737373">
